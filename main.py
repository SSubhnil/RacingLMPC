...
Laps       = 46+numSS_it      # Total LMPC laps
...
if RunPID == 1:
    ...
    file_data = open('D:\MSc_Thesis\LMPC\RacingLMPC-master\src\data\ClosedLoopDataPID.obj', 'wb')
    pickle.dump(ClosedLoopDataPID, file_data)
    file_data.close()
else:
    file_data = open('D:\MSc_Thesis\LMPC\RacingLMPC-master\src\data\ClosedLoopDataPID.obj', 'rb')
...
if RunMPC == 1:
    ...
    file_data = open('D:\MSc_Thesis\LMPC\RacingLMPC-master\src\data\ClosedLoopDataLTI_MPC.obj', 'wb')
    pickle.dump(ClosedLoopDataLTI_MPC, file_data)
    file_data.close()
else:
    file_data = open('D:\MSc_Thesis\LMPC\RacingLMPC-master\src\data\ClosedLoopDataLTI_MPC.obj', 'rb')
...
if RunMPC_tv == 1:
    ...
    file_data = open('D:\MSc_Thesis\LMPC\RacingLMPC-master\src\data\ClosedLoopDataLTV_MPC.obj', 'wb')
    pickle.dump(ClosedLoopDataLTV_MPC, file_data)
    file_data.close()
else:
    file_data = open('D:\MSc_Thesis\LMPC\RacingLMPC-master\src\data\ClosedLoopDataLTV_MPC.obj', 'rb')
...
if RunLMPC == 1:
    ...
    file_data = open('D:\MSc_Thesis\LMPC\RacingLMPC-master\src\data\LMPController.obj', 'wb')
    pickle.dump(ClosedLoopLMPC, file_data)
    pickle.dump(LMPController, file_data)
    pickle.dump(LMPCOpenLoopData, file_data)
    file_data.close()
else:
    file_data = open('D:\MSc_Thesis\LMPC\RacingLMPC-master\src\data\LMPController.obj', 'rb')
